...
console.log(Math.max(34, 345,3,233,22,312333));
// It does type coercion
console.log(Math.max(34, 3, 45,3,'233',22,31, 23, 33));
console.log(Math.max(34, 3, 45,3,'23px',22,31, 23, 33));
...
// Rounding decimals
console.log('_______Rounding decimals__________');
...
console.log(new Date('Oct 29 2021 22:18:18'));
console.log(new Date('May 05, 2003'));
